...
$stmt->execute();
echo"<script>alert('You Have Succssfully Registered');</script>";
}
?>
...
<script>
    function calculateTotalAmount() {
        ...
        var totalAmount = duration * feesPerMonth;
...
<div class="form-group">
<label class="col-sm-2 control-label">Room Size</label>
<div class="col-sm-8">
...
<div class="col-sm-8">
<input type="text" name="fpm" id="fpm"  class="form-control" onchange="calculateTotalAmount()">
</div>
</div>
...
<div class="col-sm-8">
<input type="radio" value="0" name="foodstatus"> No Mess
<input type="radio" value="1" name="foodstatus" checked="checked"> Vakula Mess
<input type="radio" value="2" name="foodstatus"> Food Court
</div>
</div>	
...
<div class="col-sm-8">
<select name="duration" id="duration" class="form-control" onchange="calculateTotalAmount()">
